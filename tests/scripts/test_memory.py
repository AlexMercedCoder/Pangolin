...
def setup_catalog(use_sts=False):
    ...
    # 2. Create Warehouse
    wh_name = "memory_warehouse_sts" if use_sts else "memory_warehouse_static"
...
if __name__ == "__main__":
    ...
    requests.delete(f"{API_URL}/tenants/{TENANT_ID}/catalogs/memory_catalog")
