...
def setup_catalog(use_sts=False):
    ...
    # 2. Create Warehouse
    wh_name = "postgres_warehouse_sts" if use_sts else "postgres_warehouse_static"
...
if __name__ == "__main__":
    ...
    requests.delete(f"{API_URL}/api/v1/catalogs/postgres_catalog")
