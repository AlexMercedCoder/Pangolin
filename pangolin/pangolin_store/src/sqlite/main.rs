...
impl CatalogStore for SqliteStore {
    ...
    async fn list_tenants(&self, pagination: Option<PaginationParams>) -> Result<Vec<Tenant>> { self.list_tenants(pagination).await }
    ...
    async fn list_warehouses(&self, tenant_id: Uuid, pagination: Option<PaginationParams>) -> Result<Vec<Warehouse>> { self.list_warehouses(tenant_id, pagination).await }
    ...
    async fn list_catalogs(&self, tenant_id: Uuid, pagination: Option<PaginationParams>) -> Result<Vec<Catalog>> { self.list_catalogs(tenant_id, pagination).await }
    ...
    async fn list_namespaces(&self, tenant_id: Uuid, catalog_name: &str, parent: Option<String>, pagination: Option<PaginationParams>) -> Result<Vec<Namespace>> { self.list_namespaces(tenant_id, catalog_name, parent, pagination).await }
    ...
    async fn list_assets(&self, tenant_id: Uuid, catalog_name: &str, branch: Option<String>, namespace: Vec<String>, pagination: Option<PaginationParams>) -> Result<Vec<Asset>> { self.list_assets(tenant_id, catalog_name, branch, namespace, pagination).await }
    ...
    async fn copy_assets_bulk(&self, tenant_id: Uuid, catalog: &str, src_branch: &str, dest_branch: &str, namespace: Option<String>) -> Result<usize> { self.copy_assets_bulk(tenant_id, catalog, src_branch, dest_branch, namespace).await }
    ...
    async fn list_branches(&self, tenant_id: Uuid, catalog_name: &str, pagination: Option<PaginationParams>) -> Result<Vec<Branch>> { self.list_branches(tenant_id, catalog_name, pagination).await }
    ...
    async fn list_tags(&self, tenant_id: Uuid, catalog_name: &str, pagination: Option<PaginationParams>) -> Result<Vec<Tag>> { self.list_tags(tenant_id, catalog_name, pagination).await }
    ...
    async fn get_commit_ancestry(&self, tenant_id: Uuid, commit_id: Uuid, limit: usize) -> Result<Vec<Commit>> { self.get_commit_ancestry(tenant_id, commit_id, limit).await }
    ...
    async fn list_users(&self, tenant_id: Option<Uuid>, pagination: Option<PaginationParams>) -> Result<Vec<User>> { self.list_users(tenant_id, pagination).await }
    ...
    async fn list_roles(&self, tenant_id: Uuid, pagination: Option<PaginationParams>) -> Result<Vec<Role>> { self.list_roles(tenant_id, pagination).await }
    ...
    async fn list_user_permissions(&self, user_id: Uuid, pagination: Option<PaginationParams>) -> Result<Vec<Permission>> { self.list_user_permissions(user_id, pagination).await }
    async fn list_permissions(&self, tenant_id: Uuid, pagination: Option<PaginationParams>) -> Result<Vec<Permission>> { self.list_permissions(tenant_id, pagination).await }
    ...
    async fn list_active_tokens(&self, tenant_id: Uuid, user_id: Option<Uuid>, pagination: Option<PaginationParams>) -> Result<Vec<TokenInfo>> { self.list_active_tokens(tenant_id, user_id, pagination).await }
    ...
    async fn list_access_requests(&self, tenant_id: Uuid, pagination: Option<PaginationParams>) -> Result<Vec<AccessRequest>> { self.list_access_requests(tenant_id, pagination).await }
    ...
    async fn list_merge_operations(&self, tenant_id: Uuid, catalog_name: &str, pagination: Option<PaginationParams>) -> Result<Vec<MergeOperation>> { self.list_merge_operations(tenant_id, catalog_name, pagination).await }
    ...
    async fn list_merge_conflicts(&self, operation_id: Uuid, pagination: Option<PaginationParams>) -> Result<Vec<MergeConflict>> { self.list_merge_conflicts(operation_id, pagination).await }
    ...
    async fn list_service_users(&self, tenant_id: Uuid, pagination: Option<PaginationParams>) -> Result<Vec<pangolin_core::user::ServiceUser>> { self.list_service_users(tenant_id, pagination).await }
