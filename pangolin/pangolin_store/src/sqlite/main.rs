        ...
        if let Some(row) = row {
            ...
            Ok(Some(User {
                ...
                created_at: Utc
                    ...
                    .unwrap_or_default(),
                updated_at: Utc
                    .timestamp_millis_opt(row.get("updated_at"))
                    .single()
                    .unwrap_or_default(),
                last_login: row
...
impl CatalogStore for SqliteStore {
    ...
    async fn list_namespaces(
        ...
        self.list_namespaces(tenant_id, catalog_name, parent, pagination)
            .await
    }
    ...
    async fn copy_assets_bulk(
        ...
        self.copy_assets_bulk(tenant_id, catalog, src_branch, dest_branch, namespace)
            .await
    }
    ...
    async fn merge_branch(
        ...
        self.merge_branch(tenant_id, catalog_name, source_branch, target_branch)
            .await
    }
    ...
    async fn get_commit(&self, tenant_id: Uuid, commit_id: Uuid) -> Result<Option<Commit>> {
        self.get_commit(tenant_id, commit_id).await
    }
    ...
    async fn get_metadata_location(
        ...
        self.get_metadata_location(tenant_id, catalog_name, branch, namespace, table)
            .await
    }
    ...
    async fn list_active_tokens(
        ...
        self.list_active_tokens(tenant_id, user_id, pagination)
            .await
    }
    ...
    async fn sync_federated_catalog(&self, tenant_id: Uuid, catalog_name: &str) -> Result<()> {
        self.sync_federated_catalog(tenant_id, catalog_name).await
    }
    async fn get_federated_catalog_stats(
        ...
        self.get_federated_catalog_stats(tenant_id, catalog_name)
            .await
    }
    ...
    async fn create_merge_operation(&self, operation: MergeOperation) -> Result<()> {
        self.create_merge_operation(operation).await
    }
    async fn get_merge_operation(&self, operation_id: Uuid) -> Result<Option<MergeOperation>> {
        self.get_merge_operation(operation_id).await
    }
    async fn list_merge_operations(
        ...
        self.list_merge_operations(tenant_id, catalog_name, pagination)
            .await
    }
    async fn update_merge_operation_status(
        ...
        self.update_merge_operation_status(operation_id, status)
            .await
    }
    async fn complete_merge_operation(
        ...
        self.complete_merge_operation(operation_id, result_commit_id)
            .await
    }
    async fn abort_merge_operation(&self, operation_id: Uuid) -> Result<()> {
        self.abort_merge_operation(operation_id).await
    }
    ...
    async fn get_merge_conflict(&self, conflict_id: Uuid) -> Result<Option<MergeConflict>> {
        self.get_merge_conflict(conflict_id).await
    }
    async fn list_merge_conflicts(
        ...
        self.list_merge_conflicts(operation_id, pagination).await
    }
    async fn resolve_merge_conflict(
        ...
        self.resolve_merge_conflict(conflict_id, resolution).await
    }
    ...
    async fn add_conflict_to_operation(&self, operation_id: Uuid, conflict_id: Uuid) -> Result<()> {
        self.add_conflict_to_operation(operation_id, conflict_id)
            .await
    }
    ...
    async fn update_service_user(
        ...
        self.update_service_user(id, name, description, active)
            .await
    }
    ...
    async fn update_service_user_last_used(
        ...
        self.update_service_user_last_used(id, timestamp).await
    }
}
