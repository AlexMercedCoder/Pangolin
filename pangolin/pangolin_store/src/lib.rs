...
use pangolin_core::model::{Asset, Branch, Catalog, Commit, Namespace, Tag, Tenant, Warehouse};
...
pub trait CatalogStore: Send + Sync + Signer {
    ...
    async fn find_conflicting_assets(
        ...
        let source_assets_with_ns = self
            .list_all_assets_in_branch(tenant_id, catalog_name, source_branch)
            .await?;
        let mut conflicts = Vec::new();

        for (source_asset, namespace) in source_assets_with_ns {
            // Try to find matching asset in target branch
            if let Some(target_asset) = self
                .get_asset(
                    tenant_id,
                    catalog_name,
    ...
    async fn create_permission(
        &self,
        _permission: pangolin_core::permission::Permission,
    ) -> Result<()> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn upsert_business_metadata(
        &self,
        _metadata: pangolin_core::business_metadata::BusinessMetadata,
    ) -> Result<()> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn create_access_request(
        &self,
        _request: pangolin_core::business_metadata::AccessRequest,
    ) -> Result<()> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn create_service_user(
        &self,
        _service_user: pangolin_core::user::ServiceUser,
    ) -> Result<()> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn create_merge_operation(
        &self,
        _operation: pangolin_core::model::MergeOperation,
    ) -> Result<()> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn update_merge_operation_status(
        &self,
        _operation_id: Uuid,
        _status: pangolin_core::model::MergeStatus,
    ) -> Result<()> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn create_merge_conflict(
        &self,
        _conflict: pangolin_core::model::MergeConflict,
    ) -> Result<()> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn resolve_merge_conflict(
        &self,
        _conflict_id: Uuid,
        _resolution: pangolin_core::model::ConflictResolution,
    ) -> Result<()> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }

    async fn add_conflict_to_operation(
        &self,
        _operation_id: Uuid,
        _conflict_id: Uuid,
    ) -> Result<()> {
    ...
    async fn validate_token(
        &self,
        _token: &str,
    ) -> Result<Option<pangolin_core::token::TokenInfo>> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn get_system_settings(
        &self,
        _tenant_id: Uuid,
    ) -> Result<pangolin_core::model::SystemSettings> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn update_system_settings(
        &self,
        _tenant_id: Uuid,
        _settings: pangolin_core::model::SystemSettings,
    ) -> Result<pangolin_core::model::SystemSettings> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
    ...
    async fn get_federated_catalog_stats(
        ...
        _tenant_id: Uuid,
        _catalog_name: &str,
    ) -> Result<pangolin_core::model::SyncStats> {
        Err(anyhow::anyhow!("Operation not supported by this store"))
    }
}
