...
impl MemoryStore {
    pub(crate) async fn create_warehouse_internal(
        &self,
        tenant_id: Uuid,
        warehouse: Warehouse,
    ) -> Result<()> {
    ...
    pub(crate) async fn get_warehouse_internal(
        &self,
        tenant_id: Uuid,
        name: String,
    ...
    pub(crate) async fn list_warehouses_internal(
        &self,
        tenant_id: Uuid,
    ...
    pub(crate) async fn delete_warehouse_internal(
        &self,
        tenant_id: Uuid,
        name: String,
    ) -> Result<()> {
