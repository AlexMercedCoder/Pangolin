...
impl MemoryStore {
    pub(crate) async fn create_merge_operation_internal(
        &self,
    ...
    pub(crate) async fn get_merge_operation_internal(
        &self,
        operation_id: Uuid,
    ...
    pub(crate) async fn list_merge_operations_internal(
        &self,
        tenant_id: Uuid,
        catalog_name: &str,
    ...
    pub(crate) async fn complete_merge_operation_internal(
        &self,
        operation_id: Uuid,
    ...
    pub(crate) async fn get_merge_conflict_internal(
        &self,
        conflict_id: Uuid,
    ...
    pub(crate) async fn list_merge_conflicts_internal(
        &self,
        operation_id: Uuid,
        pagination: Option<crate::PaginationParams>,
