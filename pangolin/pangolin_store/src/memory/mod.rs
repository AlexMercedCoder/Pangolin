...
use uuid::Uuid; // Import model types to ensure they are available
...
impl CatalogStore for MemoryStore {
    ...
    async fn update_warehouse(
        ...
        self.update_warehouse_internal(tenant_id, name, updates)
            .await
    }
    ...
    async fn create_namespace(
        ...
        self.create_namespace_internal(tenant_id, catalog_name, namespace)
            .await
    }
    ...
    async fn list_namespaces(
        ...
        self.list_namespaces_internal(tenant_id, catalog_name, parent, pagination)
            .await
    }
    ...
    async fn get_namespace(
        ...
        self.get_namespace_internal(tenant_id, catalog_name, namespace)
            .await
    }
    ...
    async fn delete_namespace(
        ...
        self.delete_namespace_internal(tenant_id, catalog_name, namespace)
            .await
    }
    ...
    async fn update_namespace_properties(
        ...
        self.update_namespace_properties_internal(tenant_id, catalog_name, namespace, properties)
            .await
    }
    ...
    async fn create_asset(
        ...
        self.create_asset_internal(tenant_id, catalog_name, branch, namespace, asset)
            .await
    }
    ...
    async fn get_asset(
        ...
        self.get_asset_internal(tenant_id, catalog_name, branch, namespace, name)
            .await
    }
    ...
    async fn list_assets(
        ...
        self.list_assets_internal(tenant_id, catalog_name, branch, namespace, pagination)
            .await
    }
    ...
    async fn delete_asset(
        ...
        self.delete_asset_internal(tenant_id, catalog_name, branch, namespace, name)
            .await
    }
    ...
    async fn get_branch(
        ...
        self.get_branch_internal(tenant_id, catalog_name, name)
            .await
    }
    ...
    async fn list_branches(
        ...
        self.list_branches_internal(tenant_id, catalog_name, pagination)
            .await
    }

    async fn delete_branch(&self, tenant_id: Uuid, catalog_name: &str, name: String) -> Result<()> {
        self.delete_branch_internal(tenant_id, catalog_name, name)
            .await
    }
    ...
    async fn list_tags(
        ...
        self.list_tags_internal(tenant_id, catalog_name, pagination)
            .await
    }

    async fn delete_tag(&self, tenant_id: Uuid, catalog_name: &str, name: String) -> Result<()> {
        self.delete_tag_internal(tenant_id, catalog_name, name)
            .await
    }
    ...
    async fn copy_assets_bulk(
        ...
        self.copy_assets_bulk_internal(tenant_id, catalog_name, src_branch, dest_branch, namespace)
            .await
    }
    ...
    async fn get_commit_ancestry(
        ...
        self.get_commit_ancestry_internal(tenant_id, head_commit_id, limit)
            .await
    }
    ...
    async fn get_metadata_location(
        ...
        self.get_metadata_location_internal(tenant_id, catalog_name, branch, namespace, table)
            .await
    }
    ...
    async fn update_metadata_location(
        ...
        self.update_metadata_location_internal(
            tenant_id,
            catalog_name,
            branch,
            namespace,
    ...
    async fn expire_snapshots(
        ...
        self.expire_snapshots_internal(
            tenant_id,
            catalog_name,
            branch,
            namespace,
    ...
    async fn remove_orphan_files(
        ...
        self.remove_orphan_files_internal(
            tenant_id,
            catalog_name,
            branch,
            namespace,
    ...
    async fn get_user_by_username(
        &self,
        username: &str,
    ) -> Result<Option<pangolin_core::user::User>> {
    ...
    async fn list_users(
        ...
        pagination: Option<PaginationParams>,
    ) -> Result<Vec<pangolin_core::user::User>> {
    ...
    async fn list_service_users(
        ...
        self.list_service_users_internal(tenant_id, pagination)
            .await
    }
    ...
    async fn update_service_user(
        ...
        self.update_service_user_internal(id, name, description, active)
            .await
    }
    ...
    async fn list_user_permissions(
        ...
        self.list_permissions_internal(Some(user_id), None, pagination)
            .await
    }
    ...
    async fn list_active_tokens(
        ...
        user_id: Option<Uuid>,
        pagination: Option<PaginationParams>,
    ) -> Result<Vec<pangolin_core::token::TokenInfo>> {
        self.list_active_tokens_internal(tenant_id, user_id, pagination)
            .await
    }
    ...
    async fn revoke_token(
        ...
        self.revoke_token_internal(_token_id, expires_at, reason)
            .await
    }
    ...
    async fn list_merge_operations(
        ...
        self.list_merge_operations_internal(tenant_id, catalog_name, pagination)
            .await
    }
    ...
    async fn complete_merge_operation(
        ...
        self.complete_merge_operation_internal(operation_id, result_commit_id)
            .await
    }
    ...
    async fn list_merge_conflicts(
        ...
        self.list_merge_conflicts_internal(operation_id, pagination)
            .await
    }
    ...
    async fn get_federated_catalog_stats(
        ...
        self.get_federated_catalog_stats_internal(tenant_id, catalog_name)
            .await
    }
    ...
    async fn update_system_settings(
        ...
        self.update_system_settings_internal(tenant_id, settings)
            .await
    }
}
