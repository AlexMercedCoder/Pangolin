...
impl MemoryStore {
    ...
    pub(crate) async fn list_namespaces_internal(
        ...
        tracing::info!(
            "DEBUG_MEM: list_namespaces tid={} cat={} parent='{}'",
            tenant_id,
            catalog_name,
            parent_prefix
        );
        ...
        let iter = self
            ...
            .filter(|entry| {
                ...
                *tid == tenant_id
                    && cat == catalog_name
                    && (parent_prefix.is_empty() || ns_str.starts_with(&parent_prefix))
            })
    ...
    pub(crate) async fn get_namespace_internal(
        &self,
        tenant_id: Uuid,
        catalog_name: &str,
    ...
    pub(crate) async fn update_namespace_properties_internal(
        &self,
        tenant_id: Uuid,
        catalog_name: &str,
        namespace: Vec<String>,
    ...
    pub(crate) async fn search_namespaces_internal(
        &self,
        tenant_id: Uuid,
        query: &str,
