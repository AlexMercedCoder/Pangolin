...
use pangolin_store::signer::{Credentials, Signer};
...
impl CatalogStore for CachedCatalogStore {
    ...
    async fn update_warehouse(
        ...
        // Perform update
        let updated_warehouse = self
            .inner
            .update_warehouse(tenant_id, name.clone(), updates)
            .await?;

        // Update cache with new value immediately
        tracing::info!("Cache UPDATE for warehouse: {}/{}", tenant_id, name);
        self.warehouse_cache
            .insert((tenant_id, name), updated_warehouse.clone())
            .await;
    ...
    async fn list_tenants(&self, pagination: Option<PaginationParams>) -> Result<Vec<Tenant>> {
        self.inner.list_tenants(pagination).await
    }
    async fn update_tenant(&self, tenant_id: Uuid, updates: TenantUpdate) -> Result<Tenant> {
        self.inner.update_tenant(tenant_id, updates).await
    }
    ...
    async fn create_warehouse(&self, tenant_id: Uuid, warehouse: Warehouse) -> Result<()> {
        self.inner.create_warehouse(tenant_id, warehouse).await
    }
    async fn list_warehouses(
        ...
        self.inner.list_warehouses(tenant_id, pagination).await
    }

    // Catalog
    async fn create_catalog(&self, tenant_id: Uuid, catalog: Catalog) -> Result<()> {
        self.inner.create_catalog(tenant_id, catalog).await
    }
    async fn get_catalog(&self, tenant_id: Uuid, name: String) -> Result<Option<Catalog>> {
        self.inner.get_catalog(tenant_id, name).await
    }
    async fn list_catalogs(
        ...
        self.inner.list_catalogs(tenant_id, pagination).await
    }
    async fn update_catalog(
        ...
        self.inner.update_catalog(tenant_id, name, updates).await
    }
    async fn delete_catalog(&self, tenant_id: Uuid, name: String) -> Result<()> {
        self.inner.delete_catalog(tenant_id, name).await
    }
    ...
    async fn create_namespace(
        ...
        self.inner
            .create_namespace(tenant_id, catalog_name, namespace)
            .await
    }
    async fn get_namespace(
        ...
        self.inner
            .get_namespace(tenant_id, catalog_name, namespace)
            .await
    }
    async fn list_namespaces(
        ...
        self.inner
            .list_namespaces(tenant_id, catalog_name, parent, pagination)
            .await
    }
    async fn delete_namespace(
        ...
        self.inner
            .delete_namespace(tenant_id, catalog_name, namespace)
            .await
    }
    ...
    async fn create_asset(
        ...
        self.inner
            .create_asset(tenant_id, catalog_name, branch, namespace, asset)
            .await
    }
    async fn get_asset(
        &self,
        ...
        self.inner
            .get_asset(tenant_id, catalog_name, branch, namespace, name)
            .await
    }
    async fn get_asset_by_id(
        ...
        self.inner.get_asset_by_id(tenant_id, asset_id).await
    }
    async fn list_assets(
        ...
        self.inner
            .list_assets(tenant_id, catalog_name, branch, namespace, pagination)
            .await
    }
    async fn delete_asset(
        ...
        self.inner
            .delete_asset(tenant_id, catalog_name, branch, namespace, name)
            .await
    }
    ...
    async fn count_namespaces(&self, tenant_id: Uuid) -> Result<usize> {
        self.inner.count_namespaces(tenant_id).await
    }
    async fn count_assets(&self, tenant_id: Uuid) -> Result<usize> {
        self.inner.count_assets(tenant_id).await
    }
    ...
    async fn create_branch(
        ...
        self.inner
            .create_branch(tenant_id, catalog_name, branch)
            .await
    }
    async fn get_branch(
        &self,
        ...
        self.inner.get_branch(tenant_id, catalog_name, name).await
    }
    async fn list_branches(
        ...
        self.inner
            .list_branches(tenant_id, catalog_name, pagination)
            .await
    }
    async fn delete_branch(&self, tenant_id: Uuid, catalog_name: &str, name: String) -> Result<()> {
        self.inner
            .delete_branch(tenant_id, catalog_name, name)
            .await
    }
    async fn merge_branch(
        ...
        self.inner
            .merge_branch(tenant_id, catalog_name, target_branch, source_branch)
            .await
    }
    async fn copy_assets_bulk(
        ...
        self.inner
            .copy_assets_bulk(tenant_id, catalog_name, src_branch, dest_branch, namespace)
            .await
    }
    async fn get_commit_ancestry(
        ...
        self.inner
            .get_commit_ancestry(tenant_id, head_commit_id, limit)
            .await
    }
    ...
    async fn find_conflicting_assets(
        ...
        self.inner
            .find_conflicting_assets(tenant_id, catalog_name, source_branch, target_branch)
            .await
    }
    async fn list_all_assets_in_branch(
        ...
        self.inner
            .list_all_assets_in_branch(tenant_id, catalog_name, branch)
            .await
    }

    // Tag Operations
    async fn create_tag(&self, tenant_id: Uuid, catalog_name: &str, tag: Tag) -> Result<()> {
        self.inner.create_tag(tenant_id, catalog_name, tag).await
    }
    async fn get_tag(
        &self,
        tenant_id: Uuid,
        ...
        self.inner.get_tag(tenant_id, catalog_name, name).await
    }
    async fn list_tags(
        &self,
        tenant_id: Uuid,
    ...
    async fn get_metadata_location(
        ...
        self.inner
            .get_metadata_location(tenant_id, catalog_name, branch, namespace, table)
            .await
    }
    ...
    async fn read_file(&self, location: &str) -> Result<Vec<u8>> {
        self.inner.read_file(location).await
    }
    ...
    async fn log_audit_event(
        ...
        self.inner.log_audit_event(tenant_id, event).await
    }
    async fn list_audit_events(
        ...
        self.inner.list_audit_events(tenant_id, filter).await
    }
    async fn get_audit_event(
        ...
        self.inner.get_audit_event(tenant_id, event_id).await
    }
    async fn count_audit_events(
        ...
        self.inner.count_audit_events(tenant_id, filter).await
    }
    ...
    async fn list_users(
        ...
        self.inner.list_users(tenant_id, pagination).await
    }
    ...
    async fn list_roles(
        ...
        tenant_id: Uuid,
        pagination: Option<PaginationParams>,
    ) -> Result<Vec<pangolin_core::permission::Role>> {
        self.inner.list_roles(tenant_id, pagination).await
    }
    async fn assign_role(&self, user_role: pangolin_core::permission::UserRole) -> Result<()> {
        self.inner.assign_role(user_role).await
    }
    async fn revoke_role(&self, user_id: Uuid, role_id: Uuid) -> Result<()> {
        self.inner.revoke_role(user_id, role_id).await
    }
    async fn get_user_roles(
        &self,
        user_id: Uuid,
    ) -> Result<Vec<pangolin_core::permission::UserRole>> {
    ...
    async fn list_user_permissions(
        ...
        self.inner.list_user_permissions(user_id, pagination).await
    }
    async fn list_permissions(
        ...
        self.inner.list_permissions(tenant_id, pagination).await
    }
    ...
    > {
        self.inner.search_assets(tenant_id, query, tags).await
    }
    async fn search_catalogs(&self, tenant_id: Uuid, query: &str) -> Result<Vec<Catalog>> {
        self.inner.search_catalogs(tenant_id, query).await
    }
    async fn search_namespaces(
        ...
        self.inner.search_namespaces(tenant_id, query).await
    }
    async fn search_branches(&self, tenant_id: Uuid, query: &str) -> Result<Vec<(Branch, String)>> {
        self.inner.search_branches(tenant_id, query).await
    }
    ...
    async fn create_access_request(
        ...
        self.inner.create_access_request(request).await
    }
    async fn get_access_request(
        &self,
        id: Uuid,
    ) -> Result<Option<pangolin_core::business_metadata::AccessRequest>> {
        self.inner.get_access_request(id).await
    }
    async fn list_access_requests(
        ...
        self.inner.list_access_requests(tenant_id, pagination).await
    }
    async fn update_access_request(
        &self,
        request: pangolin_core::business_metadata::AccessRequest,
    ) -> Result<()> {
        self.inner.update_access_request(request).await
    }
    ...
    async fn create_service_user(
        ...
        self.inner.create_service_user(service_user).await
    }
    async fn get_service_user(&self, id: Uuid) -> Result<Option<pangolin_core::user::ServiceUser>> {
        self.inner.get_service_user(id).await
    }
    ...
    async fn list_service_users(
        ...
        self.inner.list_service_users(tenant_id, pagination).await
    }
    async fn update_service_user(
        ...
        self.inner
            .update_service_user(id, name, description, active)
            .await
    }
    async fn delete_service_user(&self, id: Uuid) -> Result<()> {
        self.inner.delete_service_user(id).await
    }
    async fn update_service_user_last_used(
        ...
        self.inner
            .update_service_user_last_used(id, timestamp)
            .await
    }

    // Merge Operations
    async fn create_merge_operation(&self, operation: MergeOperation) -> Result<()> {
        self.inner.create_merge_operation(operation).await
    }
    async fn get_merge_operation(&self, operation_id: Uuid) -> Result<Option<MergeOperation>> {
        self.inner.get_merge_operation(operation_id).await
    }
    async fn list_merge_operations(
        ...
        self.inner
            .list_merge_operations(tenant_id, catalog_name, pagination)
            .await
    }
    async fn update_merge_operation_status(
        ...
        self.inner
            .update_merge_operation_status(operation_id, status)
            .await
    }
    async fn complete_merge_operation(
        ...
        self.inner
            .complete_merge_operation(operation_id, result_commit_id)
            .await
    }
    async fn abort_merge_operation(&self, operation_id: Uuid) -> Result<()> {
        self.inner.abort_merge_operation(operation_id).await
    }

    // Merge Conflicts
    async fn create_merge_conflict(&self, conflict: MergeConflict) -> Result<()> {
        self.inner.create_merge_conflict(conflict).await
    }
    async fn get_merge_conflict(&self, conflict_id: Uuid) -> Result<Option<MergeConflict>> {
        self.inner.get_merge_conflict(conflict_id).await
    }
    async fn list_merge_conflicts(
        ...
        self.inner
            .list_merge_conflicts(operation_id, pagination)
            .await
    }
    async fn resolve_merge_conflict(
        ...
        self.inner
            .resolve_merge_conflict(conflict_id, resolution)
            .await
    }
    ...
    async fn revoke_token(
        ...
        self.inner.revoke_token(token_id, expires_at, reason).await
    }
    async fn is_token_revoked(&self, token_id: Uuid) -> Result<bool> {
        self.inner.is_token_revoked(token_id).await
    }
    async fn cleanup_expired_tokens(&self) -> Result<usize> {
        self.inner.cleanup_expired_tokens().await
    }
    async fn list_active_tokens(
        ...
        self.inner
            .list_active_tokens(tenant_id, user_id, pagination)
            .await
    }
    async fn store_token(&self, token: TokenInfo) -> Result<()> {
    ...
    async fn get_system_settings(&self, tenant_id: Uuid) -> Result<SystemSettings> {
        self.inner.get_system_settings(tenant_id).await
    }
    async fn update_system_settings(
        ...
        self.inner.update_system_settings(tenant_id, settings).await
    }
