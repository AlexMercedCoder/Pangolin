...
mod tests {
    ...
    async fn test_cleanup_job_removes_expired_tokens() {
        ...
        store
            .revoke_token(expired_token1, past, Some("Test 1".to_string()))
            .await
            .unwrap();
        store
            .revoke_token(expired_token2, past, Some("Test 2".to_string()))
            .await
            .unwrap();
        ...
        store
            .revoke_token(valid_token, future, Some("Test 3".to_string()))
            .await
            .unwrap();
