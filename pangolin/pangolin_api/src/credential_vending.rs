use crate::credential_signers::{
    azure_signer::AzureSasSigner, gcp_signer::GcpTokenSigner, s3_signer::S3Signer, CredentialSigner,
};
...
pub async fn vend_credentials_for_warehouse(
    ...
    let vended_creds = signer
        .generate_credentials(resource_path, permissions, duration)
        .await?;
